    ...
    return (
        <section className={style.container}>
            <div className={style.aboutMe}>
                ...
                <p className={style.paragraph}>Soy un apasionado de la tecnología; mi objetivo principal es mantenerme siempre en continuo aprendizaje, ya sea de diferentes lenguajes de programación, con sus mejoras y actualizaciones, como del mundo IT en general.</p>
